// // This utility calculates the average payment recovery time by measuring the number of days between case creation and successful payment. 
// // It also compares the current period's recovery speed with the previous period to show performance trends.

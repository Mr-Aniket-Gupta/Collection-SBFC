  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-1">
        <p className="text-[12px] font-bold text-[var(--color-ink-muted)] uppercase tracking-wide">
          {card.title}
        </p>
        <p className="text-[28px] font-bold text-[var(--color-navy)] leading-tight">
          {card.value}
        </p>
        {card.comparisonValue && (
          <p className="text-[12px] font-semibold text-[var(--color-blue)]">
            {card.comparisonValue}
          </p>
        )}
        <div className="flex flex-wrap items-start gap-x-2 gap-y-1 mt-1">
          ...
          <span className="text-[12px] text-[var(--color-ink-muted)] leading-tight flex-1 min-w-[120px]">
            {card.subtitle}
          </span>
        </div>
      </div>
